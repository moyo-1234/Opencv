...
os.chdir(r"C:\Users\femia\Desktop\python_game_dev\Opencv\Homework\images folder")
imgpath = (r"C:\Users\femia\Desktop\python_game_dev\Opencv\Homework\images folder")
...
Family = "Family.mp4"
videofile = cv2.VideoWriter(Family,cv2.VideoWriter_fourcc(*"mp4v"),1,(width,height))
for i in imgs:
